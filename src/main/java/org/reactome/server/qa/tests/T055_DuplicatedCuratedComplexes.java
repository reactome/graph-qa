...
@QATest
public class T055_DuplicatedCuratedComplexes extends QualityAssuranceAbstract {

    @Override
    public String getDescription() {
        return "Two different instances of the class Complex that have the same instances in the hasComponent slot";
    }
    ...
    public List<String> getHeader() {
        return Arrays.asList("Complex1", "Complex1_Name", "Complex1_Created", "Complex2", "Complex2_Name", "Complex2_Created");
    }
