...
@QATest
public class T037_LiteratureReferenceRelationshipDuplication extends QualityAssuranceAbstract {

    @Override
    public String getDescription() {
        return "DatabaseObject class instances where the literatureReference slot contains duplicated entries";
    }
    ...
    public List<String> getHeader() {
        return Arrays.asList("dbIdA", "stIdA", "NameA", "dbIdB", "NameB", "Created", "Modified");
    }

    @Override
    String getQuery() {
        return " MATCH (x)-[r:literatureReference]->(y) " +
