...
@QATest
public class T043_HasCandidateRelationshipDuplication extends QualityAssuranceAbstract {

    @Override
    public String getDescription() {
        return "CandidateSet class instances where the hasCandidate slot contains duplicated entries";
    }
    ...
    @Override
    String getQuery() {
        return " MATCH (x)-[r:hasCandidate]->(y) " +
