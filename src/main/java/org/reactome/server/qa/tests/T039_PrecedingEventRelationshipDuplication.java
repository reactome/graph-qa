...
@QATest
public class T039_PrecedingEventRelationshipDuplication extends QualityAssuranceAbstract {

    @Override
    public String getDescription() {
        return "DatabaseObject class instances where the precedingEvent slot contains duplicated entries";
    }
