...
@QATest
public class T041_SummationRelationshipDuplication extends QualityAssuranceAbstract {

    @Override
    public String getDescription() {
        return "DatabaseObject class instances where the summation slot contains duplicated entries";
    }
    ...
    String getQuery() {
        return " MATCH (x)-[r:summation]->(y) " +
                ...
                "ORDER BY Created, Modified, dbIdA, stIdA, dbIdB, stIdB";
    }
}
