...
@QATest
public class T064_DuplicatedEntitySets extends QualityAssuranceAbstract {

    @Override
    public String getDescription() {
        return "Two different instances of the class EntitySet that have the same content";
    }
